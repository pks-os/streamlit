...
describe("#getContextualFillColor", () => {
  ...
  describe('with layerSelectionColorMode = "opacity"', () => {
    const layerSelectionColorMode = "opacity"
  ...
  describe('with layerSelectionColorMode = "themed"', () => {
    const layerSelectionColorMode = "themed"
    ...
    const testCases: [
      ...
      [
        "should return the unselected color with lower opacity when not selected",
        {
          isSelected: false,
          layerSelectionColorMode,
          object,
      ...
      [
        "should return the selected color with high opacity when selected",
        {
          isSelected: true,
          layerSelectionColorMode,
          object,
